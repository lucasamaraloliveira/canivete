    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-full min-h-0 pb-32">
            <div className="flex flex-col gap-6">
                ...
                <div className="relative h-[450px] bg-card-main border border-border-main rounded-[32px] shadow-sm overflow-hidden group">
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex gap-2 p-4 bg-blue-500/5 rounded-2xl border border-blue-500/10 mb-24">
